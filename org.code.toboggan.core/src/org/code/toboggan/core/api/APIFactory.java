...
public class APIFactory {
	...
	public static ProjectGrantPermissions createProjectGrantPermissions(long projectID, String grantUsername,
			int permission) {
	...
	public static UserRegister createUserRegister(String username, String firstName, String lastName, String password,
			String email) {
