...
import org.code.toboggan.network.request.extensions.user.NetworkUserLookup;
...
public class TestUserLookup extends AbstractTest {
	...
	public void testSuccessfulPath() throws InterruptedException {
		...
		IResponseData data = new UserLookupResponse(new User[]{new User(TEST_FIRST_NAME, TEST_LAST_NAME, TEST_EMAIL, testUser)});
