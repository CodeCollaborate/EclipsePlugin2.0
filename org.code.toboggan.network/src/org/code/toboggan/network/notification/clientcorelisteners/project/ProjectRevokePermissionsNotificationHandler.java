...
public class ProjectRevokePermissionsNotificationHandler implements INotificationHandler {
	...
	public void handleNotification(Notification notification) {
		...
		Set<ICoreExtension> extensions = extMgr.getExtensions(
				NetworkExtensionIDs.PROJECT_REVOKE_PERMISSIONS_NOTIFICATION_ID,
				IProjectRevokePermissionsNotificationExtension.class);
		for (ICoreExtension e : extensions) {
			IProjectRevokePermissionsNotificationExtension p = (IProjectRevokePermissionsNotificationExtension) e;
			p.permissionsRevoked(notification.getResourceID(), n.revokeUsername);
		}
	}
}
