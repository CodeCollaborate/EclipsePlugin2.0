...
public class UserResponseErrorDisplay
		implements IUserLoginResponse, IUserLookupResponse, IUserProjectsResponse, IUserRegisterResponse {
	...
	public void userRegistrationFailed(String username, String firstName, String lastName, String email) {
		Display.getDefault()
				.asyncExec(
						() -> MessageDialog
								.createDialog("Failed to register as user " + username
										+ ". Please reconnect to the server through the preferences and try again.")
								.open());
	}
	...
	public void loginFailed(String username) {
		Display.getDefault()
				.asyncExec(() -> MessageDialog
						.createDialog(
								"Failed to login to CodeCollaborate. Please reconnect to the server through the preferences and try again.")
						.open());
	}
}
